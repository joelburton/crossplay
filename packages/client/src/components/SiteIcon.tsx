...
export function SiteIcon({ className }: Props) {
  return (
    ...
    >
      ...
      <rect x="0" y="19" width="5" height="5" fill="#000" />
      <rect x="19" y="19" width="5" height="5" fill="#000" />
      <path
        d="M 12 18.6 C 4.8 13.2 4.8 6.6 8.4 6 C 10.2 6 11.4 7.2 12 8.5 C 12.6 7.2 13.8 6 15.6 6 C 19.2 6.6 19.2 13.2 12 18.6 Z"
        fill="#dc2626"
      />
      <rect
        x="0.3"
