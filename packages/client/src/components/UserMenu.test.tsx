...
describe("UserMenu", () => {
  it("renders the handle and is closed by default", () => {
    render(<UserMenu handle="Moth" onLogout={() => {}} hasNytCookie={false} onNytCookieChanged={() => {}} />);
  ...
  it("calls onLogout when the menu item is activated", () => {
    ...
    render(<UserMenu handle="Moth" onLogout={onLogout} hasNytCookie={false} onNytCookieChanged={() => {}} />);
    fireEvent.click(screen.getByRole("button", { name: /Moth/ }));
  ...
  it("closes on pointerdown outside the menu", () => {
    render(
      <>
        ...
        <UserMenu handle="Moth" onLogout={() => {}} hasNytCookie={false} onNytCookieChanged={() => {}} />
      </>,
    );
    fireEvent.click(screen.getByRole("button", { name: /Moth/ }));
    expect(screen.getByRole("menuitem", { name: "Log out" })).toBeTruthy();
